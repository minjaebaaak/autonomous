...
## v3.6: 자동 커밋 & 푸시 Phase 6.5 추가

v3.6에서 **Phase 6.5**를 추가했습니다:

- **Phase 6.5**: 작업 완료 시 자동 git commit & push (질문 금지)
- Claude Code 내장 "NEVER commit" 규칙을 `/autonomous` 호출로 명시적 override
- "커밋할까요?" 질문 = 규칙 위반
- RALPH_DONE 출력 전 커밋/푸시 완료 필수
